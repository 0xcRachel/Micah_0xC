...
// ─── Broken-image fallback (tiny 54x30 placeholder) ──────────────────────────
const NO_IMAGE_PLACEHOLDER =
  'data:image/svg+xml;utf8,' +
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="54" height="30">` +
      `<rect width="100%" height="100%" rx="5" fill="#e8e6df"/>` +
      `<text x="50%" y="55%" fill="#87867f" font-family="Segoe UI, sans-serif" font-size="9" text-anchor="middle">NO IMAGE</text>` +
      `</svg>`,
  );
